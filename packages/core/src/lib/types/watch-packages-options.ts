...
import type { RootDirOptions } from './root-dir-options.ts';

export type WatchPackagesOptions = Readonly<Prettify<ConfigOptions & PackageDataOptions & PackageGraphsOptions & RootDirOptions>>;
